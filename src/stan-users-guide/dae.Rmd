# Differential-Algebraic Equations 微分代数方程  {#dae-solver.chapter}
...
Similar to ODE solvers, the DAE solvers must not only provide the solution to the DAE itself, but also the gradient of the DAE solution with respect to parameters (the
...
## Example: chemical kinetics 示例：化学动力学
...
## Coding the DAE system function DAE系统功能的编码
...
## Control parameters for DAE solving {#control-dae.section}用于DAE求解的控制参数
