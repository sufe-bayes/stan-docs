...
### Multivariate reparameterizations 多元重参数化 {-}
...
### Vectorization through matrix operations 矩阵向量化运算 {-}
...
### Vectorized probability functions  向量化的概率函数 {-}
...
### Reshaping data for vectorization 重塑数据以进行向量化 {-}
...
## Exploiting sufficient statistics 利用充分统计量
...
## Aggregating common subexpressions 聚合常见子表达式
...
## Standardizing predictors and outputs 标准化预测变量和输出变量
